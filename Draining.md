...
##### [launch-workers-reboot.sh](http://github.com/f4tq/ethos-systemd/util/launch-booster-drain.sh)
...
##### [launch-booster-drain.sh](http://github.com/f4tq/ethos-systemd/util/launch-booster-drain.sh)
...
The fleet unit invokes [booster-drain.sh](http://github.com/f4tq/ethos-systemd/util/booster-drain.sh)
##### Example use
...
####  [booster-drain.sh](http://github.com/f4tq/ethos-systemd/util/booster-drain.sh)
The target of the fleet-unit created by  [launch-booster-drain.sh](http://github.com/f4tq/ethos-systemd/util/launch-booster-drain.sh).
...
####  [lockctl.sh](http://github.com/f4tq/ethos-systemd/util/lockctl.sh)
...
##### [mesos_sched_drain.sh](http://github.com/f4tq/ethos-systemd/util/mesos_sched_drain.sh)
#####[mesos_down.sh](http://github.com/f4tq/ethos-systemd/util/mesos_down.sh)
#####[mesos_up.sh](http://github.com/f4tq/ethos-systemd/util/mesos_up.sh)
#####[mesos_status.sh](http://github.com/f4tq/ethos-systemd/util/mesos_status.sh)
    ...
    - Ensure mesos is up and healthy
      - Flush the SKOPOS table `iptables`
		 ...
		 - Wait for reboot trigger
		   - On reboot trigger
		     	- currently, the presence of the `/var/lib/skopos/needs_reboot` is all it takes
			  	     - wait forever for cluster-wide `reboot lock` for tier
				       	    - invoke drain script with token equals `REBOOT`
					      	     - reboot *holding* drain lock
						       	      		- Especially important that the node re-establish itself *after* reboot *before* unlock.
